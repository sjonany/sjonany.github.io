...
- [Jazz standards tracker](https://sjonany.github.io/jazz-standards-tracker/). An Android app that tracks my progress on learning jazz standards.
...
- Declarative calendar. [Github](https://github.com/sjonany/Declarative-Calendar-demo-). [Blog post](posts/declarative-calendar.md)
