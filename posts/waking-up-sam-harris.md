# Waking Up - Sam Harris [Book notes]
...
- Google search: Breath awareness, body scanning
...
- "the observer-ness you felt is itself just another thought — "I am observing this" — that arose a half-second after the bare awareness, and that thought produced a subtle self-feeling. Which is exactly your #6 mechanism: a thought produced the feeling of self. So you didn't find a hole in the model; you caught it operating one level up. The fully selfless version is the bare knowing before the "I'm watching" overlay slaps a watcher onto it."
